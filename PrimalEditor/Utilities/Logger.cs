...
namespace PrimalEditor.Utilities
{
    ...
    static class Logger
    {
        ...
        {
            await Application.Current.Dispatcher.BeginInvoke(new Action(() => _messages.Add(new LogMessage(type, msg, file, caller, line))));
        }
        ...
        static Logger()
        {
            FilteredMessages.Filter += (s, e) =>
            {
                ...
                {
                    e.Accepted = (int)msg.MessageType == (_messageFilter & (int)msg.MessageType);
                }
            };
        }
    }
